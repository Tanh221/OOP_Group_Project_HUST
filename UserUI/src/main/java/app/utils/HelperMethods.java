...
public class HelperMethods {
    ...
    /**
     * This method is used to validate a string if it is a Full Name or not.
     * {@link}              https://stackoverflow.com/a/35458020
     * @param fullName      Accepts a string to validate as email address.
     * @return boolean      Returns true or false.
     * @since               1.0.0
     */
    public static boolean validateFullName(String fullName) {
//      ^                       # start of string
//      [a-zA-Z]{4,}            # 4 or more ASCII lettZers
...
//      {4, 29}                 # 5-30 character constraint given, minus the predefined first character
     ...
     * @param emailStr      Accepts a string to validate as email address.
     * @return boolean      Returns true or false.
     * @since               1.0.0
     */
...
//        $                 # end-of-string
    ...
    /**
     * This method is used to validate a string if it is a valid product quantity.
    ...
    /**
     * This method is used to validate a string if it is a double.
